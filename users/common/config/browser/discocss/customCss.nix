...
with colors; ''
    :root {
        --font-headline: 'IBM Plex Sans';
        --font-code: 'IBM Plex Mono';

        --scrollbar-auto-thumb: ${wht};
        --brand-experiment: ${gry};
        --brand-experiment-560: ${gry};
        --brand-experiment-500: ${blk};
        --selection-col: ${cya}28;
        --background-accent: ${blk};
        --local-bot-side: ${blu_d}CC;
    }
    ...
    .theme-dark {
        ...
        --background-primary: ${nbg};
        --background-secondary: ${lbg};
        --background-secondary-alt: ${lbg};
        --background-tertiary: ${blk};
        --background-floating: ${lbg};
        --background-mentioned: ${blu_d}21;
        --background-mentioned-hover: ${blu}28;

        --channeltextarea-background: ${lbg};
        --scrollbar-auto-track: ${blk};
        --modal-footer-background: ${blk};
    ...
    .theme-dark .root-g14mjS {
        ...
        border-radius: 0.5em;
        backdrop-filter: blur(0.5em);
        box-shadow: 0 0 3px 1px ${nbg}14 !important;
    }
